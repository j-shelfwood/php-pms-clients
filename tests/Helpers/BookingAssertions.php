...
function assertBookingDetails(BookingDetails $actualBooking, array $expected): void
{
    ...
    // Rate information
    assertBookingRate($actualBooking->rate, $expected['rate']);
}

function assertBookingRate(BookingRate $actualRate, array $expected): void
{
    ...
    // Tax information
    assertBookingTax($actualRate->tax, $expected['tax']);
}

function assertBookingTax(BookingTax $actualTax, array $expected): void
{
...
// Legacy wrapper functions for backward compatibility - call the consolidated function
function assertBookingDetailsMatchesExpected(BookingDetails $actualBooking): void
{
    assertBookingDetails($actualBooking, TestData::getExpectedBookingData());
}

function assertCancelBookingDetailsMatchesExpected(BookingDetails $actualBooking): void
{
    assertBookingDetails($actualBooking, TestData::getExpectedCancelBookingData());
}

function assertViewBookingDetailsMatchesExpected(BookingDetails $actualBooking): void
{
    assertBookingDetails($actualBooking, TestData::getExpectedViewBookingData());
}

function assertEditBookingDetailsMatchesExpected(BookingDetails $actualBooking): void
{
